...
RE_ALPHA_L = re.compile("(?<=[a-z\u00C0-\u00FF\u0400-\u04FF])(?=[^ a-z\u00C0-\u00FF\u0400-\u04FF])")
RE_ALPHA_R = re.compile("(?<=[^ a-z\u00C0-\u00FF\u0400-\u04FF])(?=[a-z\u00C0-\u00FF\u0400-\u04FF])")
RE_NUM_L = re.compile("(?<=[0-9])(?=[^ 0-9])")
RE_NUM_R = re.compile("(?<=[^ 0-9])(?=[0-9])")
RE_NON_ALNUM_L = re.compile("(?<=[^ 0-9a-z\u00C0-\u00FF\u0400-\u04FF])(?=[^ ])")
RE_NON_ALNUM_R = re.compile("(?<=[^ ])(?=[^ 0-9a-z\u00C0-\u00FF\u0400-\u04FF])")
